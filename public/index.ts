const assetPrefix =  '.';
// const assetPrefix =  '/demo/whiz-boost';
export const Images = {
  ...
  portfolio: {
    body: {
      project_cards: {
        card_one: assetPrefix + "/image/portfolio_assets/asset_1.jpeg",
        card_two: assetPrefix + "/image/portfolio_assets/asset_2.jpeg",
        card_three: assetPrefix + "/image/portfolio_assets/asset_3.jpeg",
        card_four: assetPrefix + "/image/portfolio_assets/asset_4.jpeg",
        card_five: assetPrefix + "/image/portfolio_assets/asset_5.jpeg",
        logo: assetPrefix + "/image/portfolio_assets/asset_8.svg",
        honours: assetPrefix + "/image//portfolio_assets/asset_7.svg"
      }
    }
  }
